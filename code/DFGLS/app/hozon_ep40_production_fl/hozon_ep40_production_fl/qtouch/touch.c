...
/* Node configurations */
qtm_acq_avr_da_node_config_t ptc_seq_node_cfg1[DEF_NUM_CHANNELS]
    = {NODE_0_PARAMS,  NODE_1_PARAMS,  NODE_2_PARAMS,  NODE_3_PARAMS,  NODE_4_PARAMS,  NODE_5_PARAMS,  NODE_6_PARAMS,
       NODE_7_PARAMS,  NODE_8_PARAMS,  NODE_9_PARAMS,  NODE_10_PARAMS, NODE_11_PARAMS, NODE_12_PARAMS, NODE_13_PARAMS,
       NODE_14_PARAMS, NODE_15_PARAMS, NODE_16_PARAMS, NODE_17_PARAMS, NODE_18_PARAMS, NODE_19_PARAMS};
...
qtm_touch_key_config_t qtlib_key_configs_set1[DEF_NUM_SENSORS]
    = {KEY_0_PARAMS,  KEY_1_PARAMS,  KEY_2_PARAMS,  KEY_3_PARAMS,  KEY_4_PARAMS,  KEY_5_PARAMS,  KEY_6_PARAMS,
       ...
       KEY_14_PARAMS, KEY_15_PARAMS, KEY_16_PARAMS, KEY_17_PARAMS, KEY_18_PARAMS, KEY_19_PARAMS};
...
static void touch_ptc_pin_config(void)
{
	...
	PORTD_pin_set_isc(2, PORT_ISC_INPUT_DISABLE_gc);

	PORTB_set_pin_pull_mode(6, PORT_PULL_OFF);
	PORTB_pin_set_isc(6, PORT_ISC_INPUT_DISABLE_gc);

	PORTD_set_pin_pull_mode(7, PORT_PULL_OFF);
	PORTD_pin_set_isc(7, PORT_ISC_INPUT_DISABLE_gc);

	PORTE_set_pin_pull_mode(4, PORT_PULL_OFF);
	PORTE_pin_set_isc(4, PORT_ISC_INPUT_DISABLE_gc);
	...
	PORTB_pin_set_isc(3, PORT_ISC_INPUT_DISABLE_gc);

	PORTB_set_pin_pull_mode(2, PORT_PULL_OFF);
	PORTB_pin_set_isc(2, PORT_ISC_INPUT_DISABLE_gc);
	...
	PORTB_pin_set_isc(7, PORT_ISC_INPUT_DISABLE_gc);
	...
	PORTD_set_pin_pull_mode(4, PORT_PULL_OFF);
	PORTD_pin_set_isc(4, PORT_ISC_INPUT_DISABLE_gc);

	PORTD_set_pin_pull_mode(3, PORT_PULL_OFF);
	PORTD_pin_set_isc(3, PORT_ISC_INPUT_DISABLE_gc);

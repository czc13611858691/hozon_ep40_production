...
static void touch_ptc_pin_config(void)
{
	...
	PORTA_pin_set_isc(2, PORT_ISC_INPUT_DISABLE_gc);

	PORTA_set_pin_pull_mode(1, PORT_PULL_OFF);
	PORTA_pin_set_isc(1, PORT_ISC_INPUT_DISABLE_gc);
	...
	PORTA_pin_set_isc(3, PORT_ISC_INPUT_DISABLE_gc);

	PORTA_set_pin_pull_mode(0, PORT_PULL_OFF);
	PORTA_pin_set_isc(0, PORT_ISC_INPUT_DISABLE_gc);
}
